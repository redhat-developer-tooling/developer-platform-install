          ...
          .run( ['$rootScope', '$location', '$timeout', 'installerDataSvc', ($rootScope, $location, $timeout, installerDataSvc) => {
            installerDataSvc.addItemToInstall(
                ...
                new CDKInstall(installerDataSvc,
                                ...
                                'https://ci.openshift.redhat.com/jenkins/job/devenv_ami/2970/artifact/origin/artifacts/release/openshift-origin-client-tools-v1.1-487-g945a0c9-945a0c9-windows.zip',
