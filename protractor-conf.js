...
if (process.env.PTOR_TEST_RUN === 'system') {
  ...
  files = ['test/ui/about-test.js', 'test/ui/login-test.js', 'test/ui/location-test.js', 'test/ui/selection-test.js', 'test/ui/confirm-test.js', 'test/ui/start-test.js', 'test/ui/install-test.js'];
