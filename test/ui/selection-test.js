...
describe('Selection page', function selectionPage() {
  let selectionForm, detectionInfo, nextButton;

  beforeAll(function() {
    browser.setLocation('selection')
      .then(function() {
        selectionForm = element(By.id('selectionForm'));
  ...
  it('should deactivate the form during detection', function() {
    expect(selectionForm.getAttribute('class')).toMatch('is-disabled');
  });
